...
const perspectiveConfigOnlyInfoPages =
  await createPerspectiveConfigOnlyInfoPages({
    portalID,
...
const TopBarInfoPage = lazy(() =>
  import("../components/main_layout/TopBarInfoPage")
);
...
const Footer = lazy(() =>
  import(`../components/perspectives/${portalID}/Footer`)
);
